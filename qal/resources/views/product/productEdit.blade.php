        ...
        <div class="col-12 table-responsive">
          <div class="card">
            <div class="card-body" style="padding: 0px;">
              <form action="{{ URL('/product-update') }}" method="POST" class="forms-sample">
                {{ csrf_field() }}    <!-- token -->
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8" style="padding-left: 0;">
                    <select name="itemgroup" id="itemgroup_id" class="select2 form-control custom-select" style="width: 100%;" required="" onchange="groupWiseSubGroup(this.value)">
                      ...
                      <option value="{{ $result->id }}" selected="">{{ $result->itemgroup }}</option>
                    </select>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8" style="padding-left: 0;">
                    ...
                    <option value="">Select</option>
                    <option value="{{ $result->id }}" selected="">{{ $result->itemsubgroup }}</option>
                    </select>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8" style="padding-left: 0;">
                    <select name="itemCategory" id="item_category_id" class="select2 form-control custom-select" style="width: 100%;" required="">
                      <option value="">Select</option>
                      <option value="{{ $result->id }}" selected="">{{ $result->itemCategory }}</option>
                    </select>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8" style="padding-left: 0;">
                    <input type="text" class="form-control" id="item_name" name="item_name" placeholder="Product Name" autocomplete="off" value="{{ $result->item_name }}" required="">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8" style="padding-left: 0;">
                    <input type="text" class="form-control" id="item_code" name="item_code" placeholder="Product Code" autocomplete="off" value="{{ $result->item_code }}" required="">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8" style="padding-left: 0;">
                    <select name="unit" id="item_unit_id" class="select2 form-control custom-select" style="width: 100%;" required="">
                      ...
                      <option value="{{ $unit->id }}" @if($result->item_unit_id==$unit->id) selected="" @endif>{{ $unit->unit }}</option>
                      @endforeach
                    </select>
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8" style="padding-left: 0;">
                    <select name="alternative_unit" id="alternative_unit" class="select2 form-control custom-select" style="width: 100%;">
                      <option value="">Select</option>
                      @foreach($itemUnit as $unit)
                      <option value="{{ $unit->id }}" @if($result->item_unit_id==$result->item_alternative_unit_id) selected="" @endif>{{ $unit->unit }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-2" style="padding-left: 0;">
                    <input type="text" class="form-control" id="whereUnit" name="whereUnit" placeholder="Unit" autocomplete="off" value="{{ $result->where_unit }}">
                  </div>
                  <label for="zoneName" class="col-sm-1 col-form-label" style="width: 10px !important;">=</label>
                  <div class="col-sm-2" style="padding-left: 0;">
                    <input type="text" class="form-control" id="whereKG" name="whereKG" placeholder="KG" autocomplete="off" value="{{ $result->where_kg }}">                    
                  </div>
                </div>  
                <div class="form-group row">
                  <label for="zoneName" class="col-sm-3 col-form-label">Item Description</label>
                  <div class="col-sm-8" style="padding-left: 0;">
                    <input type="text" class="form-control" id="description" name="description" placeholder="Description" autocomplete="off" value="{{ $result->item_description }}">
                  </div>
                </div>  
                <div class="form-group row">
...
<!-- ADD NEW INVENTORY -->
<form action="{{ URL('/product-inventory-submit') }}" method="POST" class="forms-sample">
  {{ csrf_field() }}    <!-- token -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row">
              <label for="zoneName" class="col-sm-3 col-form-label">Name</label>
              <div class="col-sm-9" style="padding-left: 0;">
                <input type="text" class="form-control" id="iname" name="iname" placeholder="New Inventory Name" autocomplete="off" value="" required="">
              </div>
            </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group row">
              <label for="zoneName" class="col-sm-3 col-form-label">Groum Name</label>
              <div class="col-sm-9" style="padding-left: 0;">
