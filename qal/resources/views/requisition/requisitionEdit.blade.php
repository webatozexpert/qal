                  ...
                  <tbody>
                    ...
                    <input type="hidden" id="prof_count" value="1">
                     ...
                     @foreach($result as $results)
                        ...
                        <tr>
                        <td style="width: 60%;">
                        <input type="text" id="unit" name="unit" class="form-control"   autocomplete="off" value="{{$results->iname}}">
                        </td>
                        <td style="width: 20%;">
                        <input type="text" id="unit" name="unit" class="form-control"   autocomplete="off" value="{{$results->unit}}">
                        </td>
                        <td style="width: 20%;">
                        <input type="text" class="form-control" id="required_quantity" name="required_quantity" autocomplete="off" value="{{$results->quantity}}">
                        </td>
                        <td>
                        <button type="button" id="addRow" class="btn btn-success" style="padding: 0px !important;" onclick="addMore()" value="Add" >delete</button>
                        </td>
                        </tr>
