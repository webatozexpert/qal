        ...
        <div class="col-12 table-responsive">
          <div class="card">
            <div class="card-body" style="padding: 0px;">
              <form action="{{ URL('/money-receipt-update') }}" method="POST" class="forms-sample">
                {{ csrf_field() }}    <!-- token -->

                <div class="form-group row">
                  <label for="zoneCode" class="col-sm-3 col-form-label">Money Receipt No</label>
                  <div class="col-sm-3" style="padding-left: 0;">
                    <input type="text" class="form-control" id="mrNo" name="mrNo" autocomplete="off" value="{{ $edit->serial_no }}" readonly="">
                  </div>

                  <label for="zoneCode" class="col-sm-3 col-form-label">Money Receipt Date</label>
                  <div class="col-sm-3" style="padding-left: 0;">
                    <input type="text" class="form-control" id="fromDate" name="mrDate" autocomplete="off" value="{{ date('d-m-Y', strtotime($edit->added_date)) }}">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9" style="padding-left: 0;">
                    <select name="bankid" id="bankid" class="select2 form-control custom-select" style="width: 100%;" required="">
                      ...
                      <option value="{{ $bank->id }}" @if($edit->bank_id==$bank->id) selected="" @endif>{{ $bank->name }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9" style="padding-left: 0;">
                    <input type="number" class="form-control" id="amount" name="amount" placeholder="Amount" autocomplete="off" value="{{ $edit->amount }}">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9" style="padding-left: 0;">
                    <textarea name="note" class="form-control" placeholder="Note">{{ $edit->note }}</textarea>
                  </div>
                </div>                
