      ...
      <div class="row">
        <div class="col-12 table-responsive">
          <h3 class="card-title text-center">Supplier/Vendor Detail Entry</h3>
            ...
            @endif
          <form action="{{ URL('/supplier-submit') }}" method="POST" class="forms-sample">
            {{ csrf_field() }}    <!-- token -->
            <div class="form-group row">
              <label for="zoneCode" class="col-sm-2 col-form-label">Company Name</label>
              <div class="col-sm-4" style="padding-left: 0;">
                <input type="text" class="form-control" id="company_name" name="company_name" placeholder="Company Name" autocomplete="off" required="">
              </div>

              <label for="zoneName" class="col-sm-2 col-form-label">Contact Person</label>
              <div class="col-sm-4" style="padding-left: 0;">
                <input type="text" class="form-control" id="contact_person" name="contact_person" placeholder="Contact Person" autocomplete="off" required="">
              </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4" style="padding-left: 0;">
                <input type="text" class="form-control" id="contact_no" name="contact_no" placeholder="Contact Number" autocomplete="off" required="">
              </div>

              <label for="zoneName" class="col-sm-2 col-form-label">Supplier Address</label>
              <div class="col-sm-4" style="padding-left: 0;">
                <input type="text" class="form-control" id="address" name="address" placeholder="Supplier Address" autocomplete="off" required="">
              </div>
