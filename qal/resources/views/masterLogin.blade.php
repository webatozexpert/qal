...
@php
    $photoAreas   = array("3", "2", "1", "4", "5", "6", "7");
    $randomNumber = rand(1, (count($photoAreas) - 1));
@endphp
...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url({{URL::asset('resources/assets/images/background/'.$randomNumber.'.jpg')}}) no-repeat center center;">            
            ...
            <div class="auth-box">
                ...
                <div id="loginform">
                    <div class="logo">
                        <span class="db"><img src="{{URL::asset('resources/assets/images/logo.png')}}" alt="logo" /></span>
                ...
                <div id="recoverform">
                    <div class="logo">
                        <span class="db"><img src="{{URL::asset('resources/assets/images/logo-icon.png')}}" alt="logo" /></span>
