    ...
    <div class="card-body">
      ...
      <div class="row">
        <div class="col-12 table-responsive">
          <h3 class="card-title text-center">Create New Memo</h3>
          <form action="{{ URL('/projectBudget-submit') }}" method="POST" class="forms-sample">
            {{ csrf_field() }}    <!-- token -->
             <div class="form-group row">
                <label for="underProject" class="col-sm-2 col-form-label">Under Project</label>
                  ...
                  <div class="col-sm-4" style="padding-left: 0;">
                    <input type="text" class="form-control" id="memo_no" name="memo_no" placeholder="Memo No" autocomplete="off" required="">
                  </div>
             </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4" style="padding-left: 0;">
                <input type="text" class="form-control" id="budgetamount" name="project_amount" placeholder="Budget Amount" autocomplete="off" required="">
              </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4" style="padding-left: 0;">
              <select name="status" id="status" class="select2 form-control custom-select" style="width: 100%;" required="">
